...
export default function RegisterModal(props: {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        await signUp(values.displayName, values.email, values.password).then(
          () => {
          ...
          <Container component="form" sx={style} onSubmit={formik.handleSubmit}>
            <Stack spacing={2}>
              ...
              >
                ...
                <FormHelperText>
                  {formik.touched.email && formik.errors.displayName}
                </FormHelperText>
              </FormControl>
              ...
              <FormControl>
                <Button
                  variant="outlined"
                  color={
                    formik.touched.additionalError &&
                    Boolean(formik.errors.additionalError)
                      ? "error"
                      : "primary"
                  }
                  type="submit"
